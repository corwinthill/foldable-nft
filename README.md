# Foldable Origami SVG NFT!

An SVG NFT project built using Scaffold-ETH 2!<br>
Current functionality includes:

- Minting basic NFTs (3 types of "Folds")
- Combining two basic NFTs into a cooler animal NFT (2 types of Animals)
- Each NFT has two attributes: color and type

Have fun folding! <br>
Contract address: <https://sepolia.etherscan.io/address/0xB2215ADC063004c6479fEB84584C6Ca19A4709e5> <br>
Live frontend: <https://foldable-nft.vercel.app>

<details>
  <summary>Click for Spoilers!</summary>
  
  - Combining different colors might be something you try
  - If you're having trouble with combinations, try a squash fold with another basic fold

</details>
<br>

# 🏗 Scaffold-ETH 2 Specifics Below
...
- [Foldable Origami SVG NFT!](#foldable-origami-svg-nft)
- [🏗 Scaffold-ETH 2 Specifics Below](#-scaffold-eth-2-specifics-below)
  - [Contents](#contents)
